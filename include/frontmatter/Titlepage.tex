...
\AddToShipoutPicture*{\backgroundpic{-4}{56.7}{figure/auxiliary/frontpageGuEngVecM2.pdf}}
...
{\Large Kacper Korban} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
% \oneLineSubtitle\\
Kacper Korban \setlength{\parskip}{1cm}

\copyright ~ Kacper Korban, \the\year. \setlength{\parskip}{1cm}

Supervisor: Magnus Myreen, Department of Computer Science and Engineering\\
Examiner: Mary Sheeran, Department of Computer Science and Engineering  \setlength{\parskip}{1cm}
